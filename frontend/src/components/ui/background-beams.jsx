...
import { motion } from "framer-motion"; // Changed from "motion/react" to "framer-motion" as we installed that
...
export const BackgroundBeams = React.memo(({
    ...
    // Memoize the random values to prevent hydration mismatches and unnecessary re-renders
    const beamOptions = React.useMemo(() => {
        return paths.map(() => ({
            y2Start: "0%",
                    ...
                    {paths.map((path, index) => (
                        <motion.linearGradient
                            ...
                            animate={{
                                ...
                                x2: ["0%", "95%"],
                                y1: ["0%", "100%"],
                                y2: ["0%", beamOptions[index].y2End],
                            }}
                            transition={{
                                duration: beamOptions[index].duration,
                                ease: "easeInOut",
                                repeat: Infinity,
                                delay: beamOptions[index].delay,
                            }}>
